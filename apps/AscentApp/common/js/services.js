						...
						function($rootScope,$http) {
							var operations = function() {
								...
								var populateDB = function(tx) {
									...
									tx.executeSql('CREATE TABLE IF NOT EXISTS MEDIA (id unique, title VARCHAR,country VARCHAR, c BIT,a BIT,m BIT,s BIT,bank BIT, govt BIT, telecom BIT, mine BIT)');
									for(var i=0;i<mediaData.length;i++) {
										tx.executeSql('INSERT INTO MEDIA (id, title,country,c,a,m,s,bank,govt,telecom,mine) VALUES ('+mediaData[i]+')');
									}
								};
